    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in {
        ...
        devShell = pkgs.mkShell {
          packages = with pkgs; [ patchelf clang llvmPackages.bintools gcc bison flex libffi tcl readline python3 zlib git gtest abc-verifier verilog boost python3Packages.boost pkg-configUpstream llvmPackages.bintools ];
        };
      }
    );
}
